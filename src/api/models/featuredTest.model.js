...
const FeaturedTestSchema = mongoose.Schema(
  {
    ...
    filter_1: { key: { type: String, default: "none"}, value: { type: String, default: "none" } },
    filter_2: { key: { type: String, default: "none" }, value: { type: String, default: "none" } },
    filters: [{ key: { type: String, default: "none" }, value: [{ type: String, default: "none" }] }],
